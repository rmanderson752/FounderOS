    ...
    <div className="min-h-screen flex bg-[#07070a]">
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div 
            ...
            style={{
              backgroundImage: `
                radial-gradient(2px 2px at 180px 100px, rgba(99,102,241,0.8), transparent),
                radial-gradient(2px 2px at 420px 220px, rgba(139,92,246,0.7), transparent),
                radial-gradient(2px 2px at 280px 350px, rgba(99,102,241,0.8), transparent)
              `,
        ...
        >
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-white leading-[1.15] tracking-tight mb-5">
            Your goals,
            <br />
            <span className="text-gray-500">reverse-engineered.</span>
          </h1>
          
          <p className="text-base text-gray-500 max-w-sm leading-relaxed mb-12">
            Set a deadline. Break it into tasks. Know exactly what to work on every day.
          </p>

          {/* Feature list */}
          <div className="space-y-3.5">
            {[
              'Goal-driven daily planning',
              'Time tracking & progress insights',
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full h-11 text-sm font-medium bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
      ...
      <style jsx>{`
        ...
        .comet-head {
          ...
          background: white;
          box-shadow: 
            0 0 10px 2px rgba(147, 197, 253, 0.8),
            0 0 20px 4px rgba(99, 102, 241, 0.6),
            0 0 30px 6px rgba(99, 102, 241, 0.3);
